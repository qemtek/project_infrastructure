...
from sklearn.metrics import balanced_accuracy_score, accuracy_score, mean_squared_error, mean_absolute_error
...
class BaseModel:
    ...
    def __init__(self, model_object=None, load_trained_model=True, save_trained_model=True,
                 test_mode=False, load_model_date=None, problem_name=None, compare_models=True,
                 is_classifier=False):
        ...
        self.performance_metrics = [balanced_accuracy_score, accuracy_score] \
            if is_classifier else [mean_squared_error, mean_absolute_error]
    ...
    def clean_input_data(self, df):
        """Add any data cleaning steps here (before generating features)"""
        return NotImplemented

    def generate_features(self, X) -> pd.DataFrame:
        """Put code to generate features from cleaned input data here"""
        return NotImplemented
    ...
    def encode_cateogrical_features(self, X) -> pd.DataFrame:
        ...
        for feature in self.categorical_features:
            ...
            self.model_features.append(X_dummies.columns)
